...
import { getRoles, getUserList, createNewUser } from 'src/store/slices/user';
...
function CreateAdminForm({ adminFormVisiblity, offices, departments, roles }) {
