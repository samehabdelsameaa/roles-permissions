...
import { updateOffice } from 'src/store/slices/settings/offices';
...
function EditOfficeForm({ officeFormVisiblity, selectedRow, selectedOffice }) {
  ...
  const { name, address, name_ar, address_ar } = selectedOffice;
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values, { setErrors, setSubmitting }) => {
      setSubmitting(true);
      officeFormVisiblity();
      dispatch(updateOffice(selectedRow, values));
      setSubmitting(false);
      setTimeout(() => {
