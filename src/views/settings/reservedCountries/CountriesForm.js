...
import { addServedCountry } from 'src/store/slices/settings/servedCountries';
...
function CountriesForm({ isOpen, onClose }) {
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values, { setErrors, setSubmitting, resetForm }) => {
      ...
      setSubmitting(true);
      dispatch(addServedCountry(values));
      setSubmitting(false);
      setTimeout(() => {
