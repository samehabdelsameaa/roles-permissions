...
import { updateUserRoles } from 'src/store/slices/auth';
...
function SetRolesForm({ className, roles }) {
                    ...
                    <Grid item xs={12} md={5}>
                      <Autocomplete
                        ...
                        onChange={(e, value) => {
                          ...
                          const rolesValues = [...rolesSetValues];
                          rolesValues[i].role = value._id;
                          setRolesSet(rolesValues);
                        }}
                        defaultValue={
                    ...
                    <Grid item xs={12} md={5}>
                      <Autocomplete
                        ...
                        onChange={(e, value) => {
                          ...
                          const rolesValues = [...rolesSetValues];
                          rolesValues[i].assignedCountry = value;
                          // setRolesSet(rolesValues);
                        }}
